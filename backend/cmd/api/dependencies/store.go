	...
	packs := []dumplings.Product{
		{
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_1.jpg",
		},
		{
			ID:          2,
			Name:        "Хинкали",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_2.jpg",
		},
		{
			ID:          3,
			Name:        "Манты",
			...
			Price:       2.75,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_3.jpg",
		},
		{
			ID:          4,
			Name:        "Буузы",
			...
			Price:       4.00,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_4.jpg",
		},
		{
			ID:          5,
			Name:        "Цзяоцзы",
			...
			Price:       7.25,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_5.jpg",
		},
		{
			ID:          6,
			Name:        "Гедза",
			...
			Price:       3.50,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_6.jpg",
		},
		{
			ID:          7,
			Name:        "Дим-самы",
			Description: "С уткой",
			Price:       2.65,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_7.jpg",
		},
		{
			ID:          8,
			Name:        "Момо",
			...
			Price:       5.00,
			Image:       "https://storage.yandexcloud.net/diplomabacket/_8.jpg",
		},
		{
			ID:          9,
			Name:        "Вонтоны",
